...
class EquipmentForm(forms.ModelForm):
    ...
    class Meta:
        '''Setting up the Input Formfields for the Website Application'''
        model = Character
        fields = ('equipt_head', 'equipt_face', 'equipt_shoulder_left', 'equipt_shoulder_right', 'equipt_torso', 'equipt_back', 'equipt_hand_left', 'equipt_hand_right', 'equipt_waist', 'equipt_legs', 'equipt_feet', 'equipt_accessory_one', 'equipt_accessory_two', 'equipt_accessory_three', 'equipt_accessory_four', 'equipt_accessory_five', 'equipt_accessory_six', 'equipt_main_hand', 'equipt_off_hand')
